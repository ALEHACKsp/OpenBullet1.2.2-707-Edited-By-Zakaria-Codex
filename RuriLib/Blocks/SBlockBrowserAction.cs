                ...
                switch (data.GlobalSettings.Selenium.Browser)
                {
                    case BrowserType.Chrome:
                        try
                        {
                            ...
                            if (data.ConfigSettings.RandomUA) chromeop.AddArgument("--user-agent=" + SpiceRUA.GetiPhoneUA());
                    ...
                    case BrowserType.Firefox:
                        try
                        {
                            ...
                            if (data.ConfigSettings.RandomUA) fireprofile.SetPreference("general.useragent.override", SpiceRUA.GetiPhoneUA());
